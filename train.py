...
def plot_metrics(results):
    ...
    ax_loss.legend()
    ax_acc.plot(results.epoch, results.history["DiceLoss"], label="Training Dice Coef")
    ax_acc.plot(results.epoch, results.history["val_DiceLoss"], label="Validation Dice Coef")
    ax_acc.legend()
